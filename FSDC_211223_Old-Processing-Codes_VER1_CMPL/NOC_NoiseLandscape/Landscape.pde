  ...
  void render() {
    ...
    for (int x = 0; x < z.length-1; x++)
    {
      ...
      for (int y = 0; y < z[x].length; y++)
      {
        ...
        float currentShade = map(noise(currentElevation), -120, 120, 0, 255);
        float currentShade2 = map(currentElevation, -120, 120, 0, 255);
        float currentShade3 = map(noise(currentElevation*100), -120, 120, 0, 255);
        fill(currentShade, currentShade2, currentShade3);
