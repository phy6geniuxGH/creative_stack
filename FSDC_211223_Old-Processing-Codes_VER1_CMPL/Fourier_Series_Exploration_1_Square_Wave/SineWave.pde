class SineWave {
  ...
  void OrbitalSineWave() {
    ...
    x += speed;
    y += speed;
    motion_X1 = SineFunction(x) + shiftWaveX;
    motion_X2 = MultipleSineFunction(x) + shiftWaveX;
    motion_X3 = AdditionSineFunction(x) + shiftWaveX;
    motion_X4 = DampedSineFunction(x) + shiftWaveX;
  } 
  void OrbitalDisplay() {
    translate(0, x2);
    rotate(radians(270));
